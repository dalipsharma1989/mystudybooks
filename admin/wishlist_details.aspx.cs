...
public partial class _Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ltr_alert_msg.Text = "";
        ltr_scripts.Text = "";
        this.Title = CommonCode.SetPageTitle("Wish List Detail");
        try
        {
    ...
    private void load_order_summary()
    {
        ...
        ds = dal.get_Wishlist_details(Request.QueryString["orderid"], "0", false, Session["iCompanyID"].ToString(), Session["iBranchID"].ToString(), out errmsg);
