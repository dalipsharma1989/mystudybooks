<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminMaster.master" CodeFile="uploadSchoolClassLogo.aspx.cs" Inherits="admin_uploadSchoolClassLogo" %>
                                ...
                                <asp:UpdatePanel runat="server" ID="upd_Panel">
                                    <ContentTemplate>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:DropDownList runat="server" ID="drp_School" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drp_School_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:DropDownList runat="server" ID="drp_Class" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                            <div  class="col-lg-4"></div>
                                        </div> 
                                    </ContentTemplate>
