<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="NewLaunch.aspx.cs" Inherits="_menu_pageNewLaunch" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2 style="font-weight: 600;font-size: 29px;">Launch</h2>
            <ol class="breadcrumb" id="ol_breadcrumb" runat="server">
                <li><a href='adminhome.aspx'>Home</a></li>
                <li class='active'><strong style="color: #3051a0">Launch</strong></li>
            </ol>
        </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-lg-10 init-validator">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validator" ControlToValidate="textName"><i class="fa fa-warning"></i>&nbsp;Required</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-lg-10 init-validator">
                                    <asp:TextBox ID="textHeaderContent" placeholder="Header Content" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group" >
                                <label class="col-lg-2 control-label">Message to Show</label>
                                <div class="col-lg-10 init-validator">
                                    <asp:TextBox ID="textmainContent" placeholder="Message to Show" TextMode="MultiLine" class="form-control" runat="server" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-lg-10 init-validator">
                                    ...
                                    <asp:RangeValidator ID="RangeValidator1" runat="server" CssClass="validator" ControlToValidate="textSortOrder" MinimumValue="0" MaximumValue="100" Type="Integer">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" class="btn btn-sm btn-success save-button" CausesValidation="false" Text="Save" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <asp:GridView ID="grd_menu" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Record Found !" AutoGenerateColumns="false"
                                PagerStyle-CssClass="asp-paging" OnPageIndexChanging="grd_menu_PageIndexChanging" OnRowCommand="grd_menu_RowCommand"> 
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Title">
                                        <ItemTemplate>
                                             <%# Eval("ISBN") %>
                                            <%--<a href="menu.aspx?NewReleaseID=<%# Eval("NewReleaseID") %>">
                                                <%# Eval("ISBN") %>
                                            </a>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField> 
                                    
                                    <asp:TemplateField HeaderText="New Release" >
                                        <ItemTemplate>
                                            <%# Eval("IsNewReleased") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Actions" >
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbdelete" CommandArgument='<%# Eval("NewReleaseID")%>' CommandName="delete_record" OnClientClick='javascript:return confirm("Do you really want to delete this Record?")'
                                                CausesValidation="false" data-toggle="tooltip" ToolTip="Delete" CssClass="btn btn-xs btn-danger" runat="server"><i class="fa fa-trash-o"></i></asp:LinkButton>
