<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="ExamNotification.aspx.cs" Inherits="_ExamNotification" ValidateRequest="false" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb" id="ol_breadcrumb" runat="server">
                ...
                <li class='active'><strong style="color:#3051a0">Exams Notification</strong></li>
            </ol>
        </div>
        <div class="col-lg-2">
            <div class="title-action">
                <a href="ExamNotification.aspx" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp;Add New</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-lg-10 init-validator">
                                    <asp:TextBox ID="textName" ReadOnly="true" placeholder="Name" class="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="form-group init-validator" style="display:none;">
                                ...
                                <div class="col-sm-10">
                                    <asp:DropDownList ID="dd_type" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="dd_type_SelectedIndexChanged">
                                        ...
                                        <asp:ListItem Value="ProductGrid">Exam Products</asp:ListItem>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 init-validator"> 
                                    ...
                                    <telerik:RadAutoCompleteBox RenderMode="Lightweight" runat="server" ID="textmainContenttelerik" EmptyMessage="Search books" DataSourceID="SqlDataSource1" 
                                        DataTextField="BookName" DataValueField="ProductID" InputType="Token" Width="100%" CssClass="search-books" DropDownWidth="100%"> </telerik:RadAutoCompleteBox>
                                    <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:ConStr %>" ProviderName="System.Data.SqlClient" 
                                        SelectCommand="select BookCode ProductID, BookName from MasterTitle where coalesce(UserDefinedField10,'') = 'Y'" runat="server"></asp:SqlDataSource>
                            ...
                            <asp:GridView ID="grd_menu" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Record Found !"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Title">
                                        <ItemTemplate>
                                            <a href="ExamNotification.aspx?ExamNotificationID=<%# Eval("ExamNotificationID") %>">
                                                <%# Eval("Name") %>
                                            </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Actions" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbdelete" CommandArgument='<%# Eval("ExamNotificationID")%>' CommandName="delete_record"
                                            ...
                                            <a href="ExamNotification.aspx?ExamNotificationID=<%# Eval("ExamNotificationID") %>" data-toggle="tootlip" title="Edit" class="btn btn-xs btn-success update-btn">
