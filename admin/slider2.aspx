<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="slider2.aspx.cs" Inherits="_Default" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong style="color:#3051a0">Big Slider Second</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="grd_slider" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Record Found !"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Background Image" ItemStyle-Width="150px">
                                        <ItemTemplate>
