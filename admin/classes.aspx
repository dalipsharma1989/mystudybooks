<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="classes.aspx.cs" Inherits="_Default" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb" id="ol_breadcrumb" runat="server">
                ...
                <li class='active'><strong>Classes</strong></li>
            </ol>
        </div>
        <div class="col-lg-2">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 init-validator">
                                    <asp:TextBox ID="textClassName" placeholder="Class Name" class="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                        CssClass="validator" ControlToValidate="textClassName">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <asp:GridView ID="grd_Classes" runat="server"
                                CssClass="table table-striped table-bordered table-hover"
                                AutoGenerateColumns="false"
                                PagerStyle-CssClass="asp-paging"
                                OnRowCommand="grd_Classes_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Class">
                                        <ItemTemplate>
                                            <a href="Classes.aspx?Classid=<%# Eval("ClassID") %>">
                                                <%# Eval("ClassName") %>
                                            </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Actions" ItemStyle-Width="100px">
                                        ...
                                        <ItemTemplate>
                                            <a href="Classes.aspx?Classid=<%# Eval("ClassID") %>" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <asp:LinkButton ID="lbdelete" CommandArgument='<%# Eval("ClassID")%>' CommandName="delete_record"
