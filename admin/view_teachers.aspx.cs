...
public partial class _Default : System.Web.UI.Page
{
    ...
    private void load_Teacher()
    {
        if (!string.IsNullOrEmpty(Request.QueryString["action"]))
        {
            ...
            {
                load_all_Teachers(true);
                h2_title.InnerText = "Pending Teachers";
            }
            else
            {
                h2_title.InnerText = "Approved Teachers";
                load_all_Teachers(false);
            }
        }
        else
        {
    ...
    private void load_all_Teachers(bool isPending)
    {
        SqlCommand com = new SqlCommand("dbo_get_all_Teachers", CommonCode.con);
    ...
    {
        if (e.CommandName == "delete_Teacher")
        {
        ...
        else if (e.CommandName == "approve_Teacher")
        {
            ...
            if (values.Length == 2)
            {
                ...
                string msg = "";
                if (isApproved)
                    msg = "Teacher Un-Apporved Successfully !";
                else
                    msg = "Teacher Apporved Successfully !";
