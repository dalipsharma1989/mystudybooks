<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="view_teachers.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row wrapper  border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2 id="h2_title" runat="server">View Teachers </h2>
            <ol class="breadcrumb">
                <li>
                    <a href="adminhome.aspx">Admin</a>
                </li>
                <li class="active">
                    <strong id="strong_li_title" runat="server">View Teachers</strong>
                </li>
            </ol>
        </div>
    </div>
                        ...
                        <asp:GridView ID="GridView2" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Document">
                                    <ItemTemplate>
                                        <a href="<%# Eval("TeacherIDProof")%>"
                                            target="_blank">Click to view Proof</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Actions" ItemStyle-Width="100px">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lbdelete" CommandArgument='<%# Eval("CustId")%>' CommandName="delete_Teacher"
                                            OnClientClick='javascript:return confirm("Do you really want to delete this Teacher?")'
                                        ...
                                        <asp:LinkButton ID="lb_approve" CommandArgument='<%# Eval("CustId")+";"+Eval("isApproved") %>' CommandName="approve_Teacher"
                                            CausesValidation="false" data-toggle="tooltip" data-html="true"
                                            OnClientClick='<%# (Eval("isApproved").ToString().ToLower()=="false"?"javascript:return confirm(\"Do you really want to Approve this Teacher?\")": "javascript:return confirm(\"Do you really want to Un-Approve this Teacher?\")") %>'
