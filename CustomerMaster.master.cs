                ...
                foreach (DataRow dr in dt_tmp_cart.Rows)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            string cart_item = "<div class='single-cart'> <div class='cart-img'> <a href = '#' ><img src='" + book["ProductImage"].ToString() + "' onError=this.onerror = null; this.src = '../resources/no-image.jpg';  alt = '" + name + "' /></a></div>";
                ...
                if (tmp_cart.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow book in (tmp_cart.AsEnumerable()))
                    {
                        try
                        {
                            ...
                            string cart_item = "<div class='single-cart'> <div class='cart-img'> <a href = '#' ><img src='" + book["ProductImage"].ToString() + "' onError=this.onerror=null;this.src='../resources/no-image.jpg';  alt = '";
