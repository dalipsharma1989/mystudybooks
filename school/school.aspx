<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SchoolMaster.master" CodeFile="school.aspx.cs" Inherits="school_school" %>
	        ...
	        <div class="row">
		        <div class="col-lg-12">
			        <div class="breadcrumbs-menu">
				        <ul>
					        <li><a href="#">Home</a></li> 
					        <li><a href="#" class="active">School Selection</a></li>
				        </ul>
			        </div>
		        </div>
	        </div> 
        ...
        <div class="space-3" style="padding:0px !important;">
            <div class="container">
                <header class="d-md-flex justify-content-between align-items-center mb-5" style="box-shadow: 10px 10px 10px 10px #f48221ab;font-family: cursive;">
                    <h2 class="font-size-26 mb-4 mb-md-0 headtext">Select Your School</h2>
                </header>
                <div class="js-slick-carousel products list-unstyled u-slick--gutters-3 my-0" data-arrows-classes="d-none d-lg-block u-slick__arrow u-slick__arrow-centered--y"
                    ...
                    <asp:Repeater ID="rp_school" runat="server">
                        <ItemTemplate> 
                                <div class="product border product__space bg-white" style="width:270px; margin:10px 10px;box-shadow: 0px 0px 10px 10px grey;border-radius:25px;">
                                    <div class="product__inner overflow-hidden p-3 p-md-4d875">
                                        <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                                            <div class="woocommerce-loop-product__thumbnail">
                                                <a href="Classes.aspx?SchoolID=<%# Eval("CustomerCode") %>&School=<%# Eval("CustomerName") %>" class="d-block">
                                                    <img src="../resources/SchoolLogo/<%# Eval("CustomerCode") %>.jpg" onError="this.onerror = null; this.src = '../resources/no-image.png';" 
                                                         style="width:150px;"  class="d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="<%# Eval("CustomerName") %>"> 
                                                </a>
                                            </div>
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                <div class="text-uppercase font-size-1 mb-1 ">
                                                    <a style="font-size:14px;font-weight:900;color: #d49547 !important;" href="Classes.aspx?SchoolID=<%# Eval("CustomerCode") %>&School=<%# Eval("CustomerName") %>"><%# Eval("CustomerName") %></a> 
                                                </div> 
                                            </div> 
                                        </div>
                                    </div>
