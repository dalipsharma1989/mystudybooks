                    ...
                    if (DataList.length > 0) {
                        for (var i = 0; i < TotLen; i++) {
                            ...
                            var HtmlRow = "<li><div class='col-lg-3 col-md-4 col-sm-6 col-xs-6'> <div style='text-align:center'>"
                                ...
                                + "<Button CausesValidation='false'   id='itemID" + DataList[i].ProductID + "' title='Add To Cart'  onclick='return ModalEntry(\"" + DataList[i].ProductID + "\")' class='" + addCartButtonShown + "' ><i class='fa fa-shopping-cart hidden-xs'></i><span class='' style='padding:0 0 0 5px;'>Add to Cart</span></Button>"
