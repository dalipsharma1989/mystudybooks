    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < TotLen; i++) {
                ...
                var HtmlRow = "<div class='col-lg-4 col-lg-6 col-sm-6 col-xs-12'><div class='small feature-box'>"
                    + "<a href='search_results.aspx?Cat=" + DataList[i].BookCategoryID + "'>"
                    + "<h6 '>" + DataList[i].BookCategoryDesc + "</h6><i class='fa fa-angle-right' aria-hidden='true'></i></a></div></div>"
